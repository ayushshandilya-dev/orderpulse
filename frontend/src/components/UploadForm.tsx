          ...
          >
            ...
            <div className="drop-zone-icon">
              {fileName ? (
                ...
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#00F2FE" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <p className="drop-zone-sub">.tar.gz · .tgz supported</p>
          </div>
        </div>

# OrderPulse — Development Progress
...
> **Module:** `github.com/orderpulse/orderpulse`

---

## What OrderPulse Does

Contestants upload a **Central Limit Order Book (CLOB) matching engine** written
in C++, Rust, Go, or Python. OrderPulse:
...
OrderPulse evaluates **CLOB matching engines only** — not trading strategies,

// Package metrics defines all Prometheus instrumentation for OrderPulse.
//
// Design rules:
...
// Registry holds all OrderPulse Prometheus metrics and the underlying
		...
		QueueDepth: prometheus.NewGauge(
			prometheus.GaugeOpts{
				...
				Help: "Current number of pending benchmark jobs in the jobs.benchmark topic " +
					"(consumer-group lag for orderpulse-workers). " +

...
import (
	...
	"github.com/orderpulse/orderpulse/internal/api"
	"github.com/orderpulse/orderpulse/internal/botfleet"
	"github.com/orderpulse/orderpulse/internal/config"
	"github.com/orderpulse/orderpulse/internal/contest"
	"github.com/orderpulse/orderpulse/internal/metrics"
	"github.com/orderpulse/orderpulse/internal/models"
	"github.com/orderpulse/orderpulse/internal/orchestrator"
	"github.com/orderpulse/orderpulse/internal/queue"
	"github.com/orderpulse/orderpulse/internal/sandbox"
	"github.com/orderpulse/orderpulse/internal/submission"
	"github.com/orderpulse/orderpulse/internal/validator"
)
...
func main() {
	...
	go func() {
		slog.Info("OrderPulse control plane ready",
			"addr", cfg.ListenAddr,
...
func tickLeaderboardWatcher(
	...
	bus.Broadcast(contest.LeaderboardEvent{Type: "update", ContestID: active.ID, ContestName: active.Name, Entries: entries})
